...
const brandsList: BrandItem[] = [
  {
    ...
    products: [
      { name: "T-Shirt", image: "https://img105.savana.com/9fd50237d6cc4ff08ede7e37689cf3dc.webp" },
      { name: "Hat", image: "https://img105.savana.com/d1203111e08244adb4fe6ffc6bb21043.webp" },
      { name: "Cap", image: "https://img105.savana.com/98f5af05efc74e51805c7e729b1f7be3.webp" }
    ]
  },
  {
    id: 302,
    ...
    products: [
      { name: "T-Shirt", image: "https://img105.savana.com/fd912543884c43c892a39219b2f63738.webp" },
      { name: "Short", image: "https://img105.savana.com/5e08c0285d82474ea9d0278e33deb10e.webp" }
    ]
  },
  {
    id: 303,
    ...
    products: [
      { name: "Utility Vest", image: "https://img105.savana.com/b624019e62da430f8e7c88b4f8c5aca2.webp" },
      { name: "Track Pants", image: "https://img105.savana.com/5b128d15efd948c983868a1302c463f7.webp" }
    ]
  },
  {
    id: 304,
    ...
    products: [
      { name: "Camo Jacket", image: "https://img105.savana.com/98f5af05efc74e51805c7e729b1f7be3.webp" },
      { name: "T-Shirt", image: "https://img105.savana.com/799cbf906744487086647c6a0ab5f8d8.webp" }
    ]
  },
  {
    id: 305,
    ...
    products: [
      { name: "T-Shirt", image: "https://img105.savana.com/d247c54bb1e84d00ac32a0d2ee340180.webp" },
      { name: "Jeans", image: "https://img105.savana.com/6d46ad99d345403bb27750081709f298.webp" },
      { name: "Hoodie", image: "https://img105.savana.com/7db1623f0bb74829afb406bcdc8cf703.webp" },
      { name: "Sock", image: "https://img105.savana.com/9d519fb69e394f14b7b7f59513a40fcd.webp" }
    ]
  },
  {
    id: 306,
    ...
    products: [
      ...
      { name: "Denim Pants", image: "https://img105.savana.com/4934e176de2f4a9eae0d137b77c9b316.webp" }
    ]
  },
  {
    id: 307,
    ...
    products: [
      ...
      { name: "Hoodie", image: "https://img105.savana.com/b778ce7f97cc4b8dacb8fc6b3f5a2f2f.webp" }
    ]
  },
  {
    id: 308,
  ...
  },
  {
    ...
    products: [
      { name: "Work Jacket", image: "https://img104.savana.com/v1/7fc092a1c5374de19f465edcf4fea863_w540_q85.webp" },
      { name: "Cargos", image: "https://img105.savana.com/b778ce7f97cc4b8dacb8fc6b3f5a2f2f.webp" }
    ]
  },
  {
    id: 310,
    ...
    products: [
      { name: "Trackies", image: "https://img105.savana.com/d1203111e08244adb4fe6ffc6bb21043.webp" },
      { name: "Knit Cap", image: "https://img105.savana.com/98f5af05efc74e51805c7e729b1f7be3.webp" }
    ]
  },
  {
    id: 311,
    ...
    products: [
      { name: "Jacket", image: "https://img105.savana.com/76a4b6083ba741079a8ef16e2c7a73e8.webp" },
      { name: "Belt", image: "https://img105.savana.com/799cbf906744487086647c6a0ab5f8d8.webp" }
    ]
  },
  {
    id: 312,
    ...
    products: [
      { name: "Box Logo Tee", image: "https://img105.savana.com/9fd50237d6cc4ff08ede7e37689cf3dc.webp" },
      { name: "Camp Cap", image: "https://img105.savana.com/d1203111e08244adb4fe6ffc6bb21043.webp" }
    ]
  }
];
...
const spotlightProducts = [
  {
    ...
    price: "₹1,499",
    img: "https://img105.savana.com/990190ec202a45a7be49d65961a83e75.webp",
    similars: [
      { name: "Raw Box Tee", img: "https://img105.savana.com/f64269193867428aaa81923d2a683436.webp", price: "₹999" },
      { name: "Signature Fit", img: "https://img105.savana.com/ed88b6e2e77f461b913d3cecb8f1c215.webp", price: "₹1,199" }
    ]
  },
  {
    id: 2,
    ...
    price: "₹2,199",
    img: "https://img105.savana.com/9104562de9d541b1ae03530cd8a58275.webp",
    similars: [
      { name: "Tactical Cargo Lower", img: "https://img105.savana.com/e5894d9178604542927c68e0d847de47.webp", price: "₹1,899" },
      { name: "Mesh Athletic Shorts", img: "https://img105.savana.com/b1f965b1c47f4aeb9324aae4a983d71e.webp", price: "₹799" }
    ]
  },
  {
    id: 3,
    ...
    price: "₹1,899",
    img: "https://img105.savana.com/82f87913d0814f9083297cfb44303ef9.webp",
    similars: [
      { name: "Distressed Denim Pants", img: "https://img105.savana.com/4a98999a637a41fba333a1881f09c60c.webp", price: "₹2,199" },
      { name: "Oversized Flannel Shirt", img: "https://img105.savana.com/156220e3ccb24d899323dae724a3951b.webp", price: "₹1,299" }
    ]
  }
];
...
export default function Explore() {
  ...
  const [selectedVariantImage, setSelectedVariantImage] = useState<string>("https://img105.savana.com/b624019e62da430f8e7c88b4f8c5aca2.webp");
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch bg-white border border-zinc-200 rounded-[32px] p-6 sm:p-8 shadow-sm">
                            ...
                            <div className="flex flex-col justify-between text-left space-y-6">
                              ...
                              <div className="space-y-4 flex-grow flex flex-col justify-between">
                                {[
                                  { title: "Tactical Cargo Lower", category: "Lower Fit", price: "₹1,899", img: "https://img105.savana.com/5b128d15efd948c983868a1302c463f7.webp" },
                                  { title: "Distressed Denim Pants", category: "Pants Fit", price: "₹2,199", img: "https://img105.savana.com/9fd50237d6cc4ff08ede7e37689cf3dc.webp" },
                                  { title: "Oversized Flannel Shirt", category: "Shirt Fit", price: "₹1,299", img: "https://img104.savana.com/v1/7fc092a1c5374de19f465edcf4fea863_w540_q85.webp" }
                                ].map((variant, idx) => (
                                  <div 
                                    key={idx}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch bg-white border border-zinc-200 rounded-[32px] p-6 sm:p-8 shadow-sm">
                      ...
                      <div className="flex flex-col justify-between text-left space-y-6">
                        ...
                        <div className="space-y-4 flex-grow flex flex-col justify-between">
                          {[
                            { title: "Tactical Cargo Lower", category: "Lower Fit", price: "₹1,899", img: "https://img105.savana.com/75e5d27d3e52464d9e57586d7078fcdb.webp" },
                            { title: "Distressed Denim Pants", category: "Pants Fit", price: "₹2,199", img: "https://img104.savana.com/v1/7fc092a1c5374de19f465edcf4fea863_w540_q85.webp" },
                            { title: "Oversized Flannel Shirt", category: "Shirt Fit", price: "₹1,299", img: "https://img105.savana.com/cecdb44ed30148609593d9750cffff01.webp" }
                          ].map((variant, idx) => (
                            <div 
                              key={idx}
                              onClick={() => setSelectedVariantImage(variant.img)}
          ...
          <div className="space-y-16 animate-in fade-in duration-300">
            ...
            <section id="instagram-section" className="mb-20 max-w-7xl mx-auto text-center">
              ...
              <div className="w-full overflow-hidden">
                <motion.div animate={{ x: -instaOffset * 220 }} transition={{ type: "spring", stiffness: 120, damping: 18 }} className="flex gap-4 w-max py-2">
                  {[
                    "https://img105.savana.com/0e94be63baf046ea9f09de69c7f4741e.webp",
