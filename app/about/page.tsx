  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow">
        {/* HERO SECTION: SLAY THE STREETS & OUR STORY (EXACT DESIGN MATCH) */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 border-b border-zinc-150">
        ...
        {/* SECTION 2: TERMS AND CONDITION & PLATFORM SHOWCASE */}
        <section id="terms-section" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 border-b border-zinc-150">
