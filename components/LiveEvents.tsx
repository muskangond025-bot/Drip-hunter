          ...
          >
            {liveEventsData.map((item) => (
              ...
              >
                ...
                <button className="w-full bg-zinc-900 hover:bg-black text-yellow-400 text-xs font-black uppercase tracking-widest py-4 transition-colors cursor-pointer border-t border-zinc-800 rounded-b-[22px]">
                  {item.buttonText}
                </button>
              </div>
            ))}
